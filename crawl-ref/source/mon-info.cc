...
// I can't think of a good short word here
    ...
    toret.push_back({"entropic burst", "entropic burst",
            [](const monster_info &mi, bool newconditions)
            {
                return mi.is(MB_ENTROPIC_BURST);
            }
        });
    toret.push_back({"chaotic infusion", "chaotic infusions",
            [](const monster_info &mi, bool newconditions)
            {
                return mi.is(MB_CHAOTIC_INFUSION);
            }
        });
...
// Not a great word but it'll turn up just after doing Enslave Soul
    ...
    toret.push_back({"degenerating", "degenerating",
            [](const monster_info &mi, bool newconditions)
            {
                return mi.is(MB_CIGOTUVI);
            }
        });
    ...
    toret.push_back({"charms averse", "charms average",
            [](const monster_info &mi, bool newconditions)
            {
                return mi.is(MB_NO_CHARMS);
            }
        });
