...
static map<monster_info_flags, pair<string, string>> monster_info_flag_names = {
    ...
    { MB_ENTROPIC_BURST, {"entropic burst", "entropic burst"} },
    { MB_CHAOTIC_INFUSION, {"chaotic infusion", "chaotic infusions"} },
    ...
    { MB_CIGOTUVI, {"degenerating", "degenerating"} },
    ...
    { MB_MUTE, {"mute", "mute"} },
    { MB_NO_CHARMS, {"charms averse", "charms averse"} },
