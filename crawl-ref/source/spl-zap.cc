...
static pair<spell_type, zap_type> _spl_zaps[] =
{
    ...
    { SPELL_ARROW_OF_SPITE,         ZAP_ARROW_OF_SPITE },
    ...
    { SPELL_WAND_DISINTEGRATE,      ZAP_DISINTEGRATE },
    ...
    { SPELL_ICICLE_CASCADE,         ZAP_CASCADE },
    { SPELL_ICICLE_CASCADE,         ZAP_CASCADE_II },
    ...
    { SPELL_HAILSTORM,              ZAP_HAILSTORM_CHAOS },
    ...
    { SPELL_BREATHE_VAMPIRIC,       ZAP_BREATHE_BLOOD },
    { SPELL_BREATHE_RADIATION,      ZAP_BREATHE_RADIATION },
