...
{ // Swamp
  ...
  // Harmless Ambience
  {  1,  4,   100, FLAT, MONS_GIANT_BLOWFLY },
  // Easy enemies:
  {  1,  4,   500, FALL, MONS_VAMPIRE_MOSQUITO },
  {  1,  4,   400, FLAT, MONS_SPHINX_MOTH },
  ...
  {  1,  4,   300, FLAT, MONS_TYRANT_LEECH },
  {  1,  4,   700, FALL, MONS_GOLIATH_FROG  },
  {  1,  4,   300, FLAT, MONS_GOLIATH_FROG },
  ...
  {  1,  4,   20, FLAT, MONS_CHAOS_BUTTERFLY },
