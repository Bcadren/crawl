...
public:
    ...
    virtual int wearing(equipment_type slot, int sub_type,
                        bool calc_unid = true, bool count_jiyva = true,
                        bool check_active = false) const = 0;
    ...
    virtual void paralyse(const actor *attacker, int strength,
                          string source = "") = 0;
    virtual void petrify(const actor *attacker, bool force = false, bool mt = false) = 0;
    virtual bool fully_petrify(const actor *atk = nullptr, 
                               bool quiet = false, bool mt = false) = 0;
    ...
    virtual int spiky_odds(skill_type skill) const = 0;
