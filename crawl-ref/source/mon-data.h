...

{
    ...
    { { AT_BITE, AF_FROG, 0 }, { AT_SLAM, AF_PLAIN, 30},  AT_NO_ATK, AT_NO_ATK },
    9, 500,
    4, 18, MST_TONGUE_LASH, CE_CLEAN, S_SILENT, // IRL, goliath frogs have no vocals!
    I_ANIMAL, HT_AMPHIBIOUS, 8, SWIM_ENERGY(6),
    MU_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED_TAILLESS,
...

{
    ...
    16, 640,
    3, 14, MST_FENSTRIDER_WITCH, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
